                            ...
                            <div className="d-flex align-items-center border rounded-3 px-3">
                                <div className="d-flex align-items-center w-100 py-2">
                                    ...
                                    <div className="w-50 pl-5">
                                        <div className="fw-bold mb-1 fs-5">상품비교</div>
                                        <div className="fs-6_5">각 스토어 아이템을 한눈에 비교 분석</div>
                                    </div>
                                </div>
                            ...
                            <div className="d-flex align-items-center border rounded-3 px-3">
                                <div className="d-flex align-items-center w-100 py-2">
                                    ...
                                    <div className="50 pl-5">
                                        <div className="fw-bold mb-1 fs-5">오프라인 스토어 길찾기</div>
                                        <div className="fs-6_5">간편한 스토어 길찾기</div>
                                    </div>
                                </div>
                                <i className="bi bi-chevron-right me-1"></i>
                            </div>
                        ...
                        <a onClick={() => goCard()} target="_self">
                            <div className="d-flex align-items-center border rounded-3 px-3">
                                <div className="d-flex align-items-center w-100 py-2">
                                    ...
                                    <div className="w-50 pl-5">
                                        <div className="fw-bold mb-1 fs-5">스토어 랭킹</div>
                                        <div className="fs-6_5">어떤 스토어가 인기가 있을까?</div>
                                    </div>
                                </div>
                                <i className="bi bi-chevron-right me-1"></i>
                            </div>
                        ...
                        <a onClick={() => goSupport()} target="_self">
                            <div className="d-flex align-items-center border rounded-3 px-3">
                                <div className="d-flex align-items-center w-100 py-2">
                                    ...
                                    <div className="w-50 pl-5">
                                        <div className="fw-bold mb-1 fs-5">스토어 찾기</div>
                                        <div className="fs-6_5">원하는 스토어를 검색</div>
                                    </div>
                                </div>
                                <i className="bi bi-chevron-right me-1"></i>
                            </div>
