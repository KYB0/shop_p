        ...
        <main className="d-flex form-signin text-center bg-light"
            ...
            <div className="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark">
                <a href="/admin/main" className="d-flex justify-content-center text-white text-decoration-none">
                    <span className="fs-4"><i className="bi bi-house me-2"></i>look-mon</span>
                </a>
                <hr/>
            ...
            <div className="d-flex flex-column w-100 p-5 vh-100">
                <div className="d-flex align-items-center mb-4">
                    <div className="fs-3">반갑습니다, 룩몬님.</div>
                    <a href="/admin/customer/register" className="btn btn-primary ms-auto">의류 쇼핑몰/스토어 등록</a>
                </div>

                <div className="input-group mb-5">
                    <input type="hidden" name="" id="" value="title"/>
                    <input onChange={() => handleSearch()} id="searchData" type="text" className="form-control py-3" placeholder="의류 쇼핑몰 / 스토어명을 입력하세요."
                           aria-label="의류 쇼핑몰 / 스토어명을 입력하세요."
                ...
                <div className="table-responsive">
                    <table className="table u-table--v3" role="grid">
                        ...
                        <tr role="row">
                            <th className="text-center">의류 쇼핑몰 / 스토어명</th>
                ...
                <footer id="footer" className="u-footer--bottom-sticky mt-auto fs-6_5">
                    <div className="row align-items-center">
                        <div className="text-center">
                            <div className="d-block">· COPYRIGHT(c) 2023 룩몬 ALL RIGHTS RESERVED .</div>
                        </div>
                    </div>
                </footer>
            </div>
